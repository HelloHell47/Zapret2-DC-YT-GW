...
--lua-desync=fake:blob=tls_4pda:tcp_ts=-1000 ^
--new ^
...
--payload=unknown ^
--out-range="s1<d1" ^
--lua-desync=fake:blob=tls_4pda:ip_ttl=6:repeats=1:payload=unknown --lua-desync=pktmod:ip_ttl=1 ^
--new ^

--filter-tcp=2053,2083,2087,2096,8443 ^
--hostlist-domains=discord.media ^
--lua-desync=hostfakesplit:repeats=4:tcp_ts=-1000:host=www.google.com ^
--new ^
...
--out-range=-d10 ^
--payload=tls_client_hello ^
--lua-desync=multisplit:blob=tls_google:tcp_ts=-1000:pos=2:nodrop:repeats=1 ^
...
--lua-desync=fake:blob=quic_steam:repeats=3 ^
--new ^
